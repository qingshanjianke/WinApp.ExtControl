...
[TemplatePart(Name = CountPerPageNumericBoxTemplateName, Type = typeof(ComboBox))]
...
public class Pagination : Control
{
    ...
    private ComboBox _countPerPageNumericBox;
    ...
    public static readonly DependencyProperty CountPerPageProperty =
        DependencyProperty.Register("CountPerPage", typeof(int), _typeofSelf, new PropertyMetadata(50, OnCountPerPagePropertyChanged, CoerceCountPerPage));
    ...
    public IEnumerable<int> CountPerPageSource
    {
        get { return (IEnumerable<int>)GetValue(CountPerPageSourceProperty); }
        set { SetValue(CountPerPageSourceProperty, value); }
    }
    public static readonly DependencyProperty CountPerPageSourceProperty =
        DependencyProperty.Register("CountPerPageSource", typeof(IEnumerable<int>), _typeofSelf, new PropertyMetadata(null));
    ...
    private static void OnCountPerPagePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        if (ctrl._countPerPageNumericBox != null)
            ctrl._countPerPageNumericBox.SelectedItem = countPerPage;
    ...
    public override void OnApplyTemplate()
    {
        ...
        _countPerPageNumericBox = GetTemplateChild(CountPerPageNumericBoxTemplateName) as ComboBox;
    ...
    private void Init()
    {
        ...
        _countPerPageNumericBox.SelectedItem = CountPerPage;
    ...
    private void UnsubscribeEvents()
    {
        if (_countPerPageNumericBox != null)
            _countPerPageNumericBox.SelectionChanged -= OnCountPerPageTextBoxChanged;
